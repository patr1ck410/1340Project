...
main : main.o action.o action.o checkwin.o drawcard.o initialization.o insert.o loadandsave.o minigame.o output.o structures.o terminate.o
	g++ $^ -o $@
...
main.o : main.cpp action.h checkwin.h drawcard.h initialization.h insert.h loadandsave.h minigame.h output.h structures.h terminate.h
	g++ -c $<
